// TODO: Hard-delete (GC) flow for soft-deleted topics. See `TODO.md`.
// Should: iterate `deleted_topics`, and for each whose `gc_after` has elapsed,
// drop the in-memory topic state and physically delete its blob containers.
